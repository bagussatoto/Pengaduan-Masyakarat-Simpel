                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Silahkan Login, Ngab!</h1>
                                        </div>
                                        <form class="user" method="post" action="cek_login.php">
                                            <div class="form-group">
                                            <label class="ml-2 mb-0 text-gray-700">Username</label>
                                                <input type="text" class="form-control form-control-user" name ="username" placeholder="Masukkan Username ...">
                                            </div>
                                            <div class="form-group">
                                            <label class="ml-2 mb-0 text-gray-700">Password</label>
