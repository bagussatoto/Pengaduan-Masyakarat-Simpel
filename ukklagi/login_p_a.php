...
<body>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4 ">Hai, Petugas/Admin!</h1>
                                        </div>
                                        <form class="user" method="post" action="cek_login_p_a.php">
                                            <div class="form-group">
                                                <label class="ml-2 mb-0 text-gray-800">Username</label>
                                                <input type="text" class="form-control form-control-user" name ="username" placeholder="Masukkan Username ...">
                                            </div>
                                            <div class="form-group">
                                                <label class="ml-2 mb-0 text-gray-800">Password</label>
                                        ...
                                        <div class="text-center">
                                            <div class="small">Belum Punya Akun?
                                                <a href="register.php">Buat Akun!</a>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="text-center">
                                            <a class="small" href="login_m.php">Kembali</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
  ...
  <script src="sjs/sb-admin-2.min.js"></script>
