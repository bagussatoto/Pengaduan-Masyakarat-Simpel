        ...
        <div class="card-body">
            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <a href="?url=verifikasi_pengaduan" class="btn btn-warning btn-icon-split">
                        <span class="icon">
                    ...
                    <a href="?url=proses_verifikasi&id=<?php echo $d['id_pengaduan'];?>" class="btn btn-danger btn-icon-split">
                        <span class="icon">
